...
import com.example.drawingpsychologicaltest.result.ResultActivity5;

public class ActivityPaint5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.avtivity_paint5);

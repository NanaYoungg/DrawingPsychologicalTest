...
import com.example.drawingpsychologicaltest.result.ResultActivity7;

public class ActivityPaint7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.avtivity_paint7);

...
import com.example.drawingpsychologicaltest.result.ResultActivity6;

public class ActivityPaint6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.avtivity_paint6);

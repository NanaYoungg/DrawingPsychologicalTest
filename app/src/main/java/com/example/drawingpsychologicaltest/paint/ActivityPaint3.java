...
import com.example.drawingpsychologicaltest.result.ResultActivity3;

public class ActivityPaint3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.avtivity_paint3);

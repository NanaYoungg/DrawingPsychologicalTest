...
import com.example.drawingpsychologicaltest.result.ResultActivity8;

public class ActivityPaint8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.avtivity_paint8);
